...
public class FriendsPanel extends javax.swing.JLayeredPane implements MouseListener, TwitzEventModel/*, ActionListener*/
{
    ...
    public FriendsPanel() {
		...
		actionMap = TwitzApp.getContext().getActionMap(FriendsPanel.class, this);
        initComponents();
		initDefaults();
    }
...
//	//			requestFocusInWindow();
	...
	public void updateList(final PagableResponseList users)//{{{
	{
		if(users != null)
		{
			...
			{
				//ResponseList<User> res = results;

				public ContactsListModel doInBackground()
				{
					firePropertyChange("started", null, "proccessing friends list");
					...
					for(Object u : users)
					{
						...
						firePropertyChange("message", null, String.format("loading %d of %d friends. please wait...", count, total));
						count++;
					}
					return clm;
				}
	...
	final static Logger logger = Logger.getLogger(FriendsPanel.class.getName());
